...
cloudbasedir='/eodata/Sentinel-3/SLSTR/SL_1_RBT' # Base folder where the sentinel-2 L1c images are located
...
if __name__=='__main__':
    ...
    for s2_file in file_list:
        ...
        for input_file in filenames:
            ...
            output_file = sen.reproject_S3_SNAP(pth.join(clouddir,input_file),
                                          input_epsg,
                                          resolution,
                                          extent=extent,
                                          output_file=None,
